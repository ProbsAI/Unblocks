...
- **This grant does not apply to ProbsAI.** Contributions made by ProbsAI, Inc., its employees, contractors, or agents acting within the scope of their engagement with ProbsAI are not subject to the Contributor Patent Grant. ProbsAI's own patent rights are reserved in full per [PATENTS.md](./PATENTS.md).
